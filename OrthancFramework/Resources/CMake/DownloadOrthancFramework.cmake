...
if (ORTHANC_FRAMEWORK_SOURCE STREQUAL "hg" OR
  ...
  if (NOT DEFINED ORTHANC_FRAMEWORK_BRANCH)
    if (ORTHANC_FRAMEWORK_VERSION STREQUAL "mainline")
      ...
      elseif (ORTHANC_FRAMEWORK_VERSION STREQUAL "4e7b2af98475")
        # Worklists plugin 1.0.0 (framework pre-1.12.10)
        set(ORTHANC_FRAMEWORK_PRE_RELEASE ON)
        set(ORTHANC_FRAMEWORK_MD5 "d80cf200b16ff194c464d5a21d56055d")
      endif()
    endif()
  endif()
