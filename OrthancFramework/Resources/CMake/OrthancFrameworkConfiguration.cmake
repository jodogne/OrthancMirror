...
set(ORTHANC_CORE_SOURCES_INTERNAL
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../Sources/ElapsedTimer.cpp
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../Sources/FileStorage/StorageRange.cpp
...
#####################################################################
## Publishing the list of the applied patches
#####################################################################

list(LENGTH ORTHANC_PATCHES_LIST ORTHANC_PATCHES_COUNT)

if (ORTHANC_PATCHES_COUNT GREATER 0)
  list(JOIN   ORTHANC_PATCHES_LIST "\",\n  \"" ORTHANC_PATCHES_C_BODY)
  set(ORTHANC_PATCHES_C_BODY "\"${ORTHANC_PATCHES_C_BODY}\"")
else()
  set(ORTHANC_PATCHES_C_BODY "")
endif()

configure_file(
  ${CMAKE_CURRENT_LIST_DIR}/PatchList.h.in
  ${AUTOGENERATED_DIR}/PatchList.h
  @ONLY
  )

configure_file(
  ${CMAKE_CURRENT_LIST_DIR}/PatchList.cpp.in
  ${AUTOGENERATED_DIR}/PatchList.cpp
  @ONLY
  )
