...
namespace Orthanc
{
    ...
    if (call.IsDocumentation())
    {
      ...
      call.GetDocumentation()
        ...
        .SetRequestField(KEY_TIMEOUT, RestApiCallDocumentation::Type_Number,
                         "DICOM SCU Timeout for this C-ECHO command, in seconds.  Orthanc will close the DICOM association if no C-ECHO answer is received within this time period.", false)
  ...
  static void DicomQuery(RestApiPostCall& call)
  {
    if (call.IsDocumentation())
    {
      call.GetDocumentation()
        ...
        .SetRequestField(KEY_TIMEOUT, RestApiCallDocumentation::Type_Number,
                         "DICOM SCU Timeout for this C-FIND command and subsequent C-GET/C-MOVE retrievals, in seconds (new in Orthanc 1.9.1).  Orthanc will close the related DICOM associations if no DICOM messages are received within this time period.", false)
  ...
  static void DocumentRetrieveShared(RestApiPostCall& call)
  {
    ...
    call.GetDocumentation()
      ...
      .SetRequestField(KEY_TIMEOUT, RestApiCallDocumentation::Type_Number,
                       "DICOM SCU Timeout for this C-MOVE or C-GET command, in seconds.  Orthanc will close the DICOM association if no DICOM messages (e.g., C-STORE sub-operations or responses) are received within this time period.", false)
    ...
    if (call.IsDocumentation())
    {
      ...
      call.GetDocumentation()
        ...
        .SetRequestField(KEY_QUERY, RestApiCallDocumentation::Type_JsonObject,
                         "Associative array containing the filter on the values of the DICOM tags", true)
        .SetRequestField(KEY_TIMEOUT, RestApiCallDocumentation::Type_Number,
                         "DICOM SCU Timeout for this C-FIND command, in seconds (new in Orthanc 1.9.1)", false)
  ...
  static void DicomStore(RestApiPostCall& call)
  {
    ...
    if (call.IsDocumentation())
    {
      ...
      call.GetDocumentation()
        ...
        .SetRequestField(KEY_TIMEOUT, RestApiCallDocumentation::Type_Number,
                         "DICOM SCU Timeout for this C-STORE command, in seconds.  Orthanc will close the DICOM association if no DICOM messages (e.g., C-STORE responses) are received within this time period.", false)
        .SetUriArgument("id", "Identifier of the modality of interest");
      return;
    }
  ...
  static void DicomMove(RestApiPostCall& call)
  {
    if (call.IsDocumentation())
    {
      ...
      call.GetDocumentation()
        ...
        .SetRequestField(KEY_TIMEOUT, RestApiCallDocumentation::Type_Number,
                         "DICOM SCU Timeout for this C-MOVE command, in seconds.  Orthanc will close the DICOM association if no DICOM messages (e.g., C-STORE sub-operations or responses) are received within this time period.", false)
        .SetUriArgument("id", "Identifier of the modality of interest");
      return;
    }
    ...
    if (call.IsDocumentation())
    {
      ...
      call.GetDocumentation()
        ...
        .SetRequestField(KEY_LOCAL_AET, RestApiCallDocumentation::Type_String,
                         "Local AET that is used for this commands, defaults to `DicomAet` configuration option or `LocalAet` in the `DicomModalities`. ", false)
        .SetRequestField(KEY_TIMEOUT, RestApiCallDocumentation::Type_Number,
                         "DICOM SCU Timeout for this C-GET command, in seconds.  Orthanc will close the DICOM association if no DICOM messages are received within this time period.", false)
        .SetUriArgument("id", "Identifier of the modality of interest");
      return;
    }
  ...
  static void StorageCommitmentScu(RestApiPostCall& call)
  {
    ...
    if (call.IsDocumentation())
    {
      call.GetDocumentation()
        ...
        .SetRequestField(KEY_TIMEOUT, RestApiCallDocumentation::Type_Number,
                         "DICOM SCU Timeout for this storage commitment command (new in Orthanc 1.9.1)", false)
        .SetAnswerField("ID", RestApiCallDocumentation::Type_JsonObject,
